                                ...
                                if (row4.startDate !== undefined && row4.startDate != 'undefined') {
                                    ...
                                    if (eventInstituteItemStyle?.rowsData.length > 0) {
                                        ...
                                        let eventSubItemFacilityData = [
                                            0, // itemId or counselorId
                                            0, // itemSubId or counselorSubId
                                            0, // priority
                                            0, // headerOrder
                                            0, // filterId
                                            0, // itemPrice or counselorPrice
                                            mappingId, // mappingId
                                            0, // required
                                            0, // defaultSelected
                                            0, // singleSelected
                                            0, // unchangeable
                                            0, // parentItemId or parentCounselorId
                                            '[[]]', // requiredItemId or requiredCounselorId
                                            '[[]]', // prohibitionItemId or prohibitionCounselorId
                                            '[]', // chainItemId or chainCounselorId
                                            updatedAt, // createdAt
                                            updatedBy, // createdBy
                                            updatedAt, // updatedAt
                                            updatedBy // updatedBy
                                        ];
                                        eventSlotSubRecords.push(eventSubItemFacilityData);
                                        ...
                                        for (let i = 0; i < itemDatas.length; i++) {
                                            ...
                                            if (itemData.selectedItemConditions?.length > 0) {
                                                itemData.selectedItemConditions.forEach((selectedItemCondition, index) => {
                                                    ...
                                                    eventSubItem = [
                                                        itemData.buttonId, // itemId or counselorId
                                                        index, // itemSubId or counselorSubId
                                                        index, // priority
                                                        ...
                                                        parentItemIds[itemData.buttonId], // parentItemId or parentCounselorId
                                                        getRequiredItemIdValues(itemData.buttonId, requiredItemIdValues), // requiredItemId or requiredCounselorId
                                                        getProhibitionItemIdValues(itemData.buttonId, prohibitionItemIdValues), // prohibitionItemId or prohibitionCounselorId
                                                        // eventSlotItemObj.otherChainItemId ? `[${eventSlotItemObj.otherChainItemId}]` : '[]', // chainItemId or chainCounselorId
                                                        chainItemJSON, // chainItemId or chainCounselorId
                                                        updatedAt, // createdAt
                                                        updatedBy, // createdBy
                                                        updatedAt, // updatedAt
                                                        updatedBy // updatedBy
                                                    ...
                                                    eventSlotSubRecords.push(eventSubItem);
                                                });
                                            }
                                        }
                                        ...
                                        let eventSlotInsertSql = `INSERT INTO EventSlot(
                                            mappingId,
                                            datetime,
                                            ${eventInstituteItemType == 1 ? 'counselorId' : 'itemId'},
                                            ${eventInstituteItemType == 1 ? 'counselorSubId' : 'itemSubId'},
                                            sort,
                                            maxReservationCount,
                                            reservationCount,
                                            slotFilterQuery,
                                        ...
                                        if (eventInstituteItemType == 1) { //For Counselor
                                            eventSubSql = `INSERT INTO EventSubCounselor(
                                                counselorId,
                                                counselorSubId,
                                                priority,
                                                headerOrder,
                                            ...
                                            eventSubSql = `INSERT INTO EventSubItem(
                                                itemId,
                                                itemSubId,
                                                priority,
                                                headerOrder,
                                        ...
                                        await mysql_con.query(eventSubSql, [eventSlotSubRecords]);
